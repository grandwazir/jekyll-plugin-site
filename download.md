...
You can also build {{ site.title }} from the source if you would prefer to do so. This is useful for those who wish to modify {{ site.title | capitalize }} before using it or want to contribute new features. 
